...
Source: https://github.com/Zerg00s/powershell-forms

.DESCRIPTION

	This is a simple 1 file include for powershell to generate forms.
...
function Get-FormArrayItem {
    ...
    if($ControlType -eq [ControlType]::RadioButtons){
        ...
        foreach ($item in $items) {
            ...
            $RadioButton.size = "1240,$radioButtonHeight" 
